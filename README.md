# libStorage [![GoDoc](https://godoc.org/github.com/emccode/libstorage?status.svg)](https://godoc.org/github.com/emccode/libstorage) [![Build Status](https://travis-ci.org/emccode/libstorage.svg?branch=master)](https://travis-ci.org/emccode/libstorage) [![Go Report Card](https://goreportcard.com/badge/emccode/libstorage)](https://goreportcard.com/report/emccode/libstorage) [![Coverage Status](https://coveralls.io/repos/emccode/libstorage/badge.svg?branch=master&service=github)](https://coveralls.io/github/emccode/libstorage?branch=master)
